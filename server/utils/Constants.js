module.exports = {
  ...
  USER_CANNOT_DELETE_SUPERADMIN:
    "You cannot delete superadmin who created this group",
  ...
  DELETE_CAN_ONLY_BE_FROM_ME_OR_EVERYONE:
    "Deleted message can only be Me/Everyone",
  MESSAGE_ALREADY_DELETED_FROM_EVERYONE:
    "Message is already deleted from everyone",
};
